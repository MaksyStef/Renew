      ...
      <PageWrapper className="p-4">
        ...
        <div className="row row-cols-1 w-100 mt-4 g-4 text-center">
          ...
          <template id="cell-template">
            <a style={{textDecoration: "none", cursor: "pointer"}} className="text-white cell-link col col-md-6 text-start">
              <div style={{
                "margin": "0 auto",
                "width": "fit-content",
              }}>
                <div className="position-relative">
                  ...
                  <h1 className="cell-tittle display-3 fw-normal w-100 ps-4">Project Name</h1>
                </div>
                ...
                <p className='cell-details d-block fs-5 fw-light w-100 text-truncate'>Details are very long, so we need to wrap them properly.</p>
              </div>
            </a>
          </template>
        </div>
